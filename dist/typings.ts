export type EvpBaseEvenNumbers =
  | "2px"
  | "4px"
  | "6px"
  | "8px"
 ...
 */
export type EvpAnimationDirection = Hintable<
  | "normal"
  | "alternate"
  | "reverse"
  | "intitial"
...
export type EvpAnimationFillMode = Hintable<
  "forwards" | "backwards" | "both" | "none" | "unset" | "inherit" | "initial"
>;

export type EvpAnimationTimeFunction = Hintable<
  | "ease"
  | "ease-in"
  | "ease-out"
  | "ease-in-out"
