...
import Example from "../demos/animation/fade-out/example";
import AnimationApi from "../apis/animation.api";
import Trigger from "../demos/animation/fade-out/trigger";
...
FadeOut is an effect that makes a element zoom fade out.
