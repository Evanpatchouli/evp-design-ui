...
import Example from "../demos/animation/zoom-in/example";
import AnimationApi from "../apis/animation.api";
import Trigger from "../demos/animation/zoom-in/trigger";
...
ZoomIn is an effect that makes a element zoom into view.
