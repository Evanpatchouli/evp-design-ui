...
import Example from "../demos/animation/shake/example";
...
Shake is an effect that makes a element bounce vertically when clicked or hovered.
...
Here are some examples about Animation.Shake
