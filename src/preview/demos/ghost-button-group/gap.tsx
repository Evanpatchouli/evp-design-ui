  ...
  return (
    <>
      <Row>
        ...
        <GhostButtonGroup gap={12} mgr_40 items={items} children={<SvgIcon.Component />} direction="down" />

        <GhostButtonGroup gap={20} mgr_40 items={items} children={<SvgIcon.Component />} direction="down" />
        <GhostButtonGroup gap={6} mgr_40 items={items} children={<SvgIcon.Component />} direction="down" />
      </Row>
    </>
  );
};
