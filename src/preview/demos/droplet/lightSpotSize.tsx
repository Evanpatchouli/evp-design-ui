...
const Demo: React.FC = () => {
  return (
    <Row>
      <Droplet borderRadius="10px" lightSpot={8} w={100} h={100} children={"false"} />
      <Droplet borderRadius="10px" lightSpot={8} lightSpotSize={20} w={100} h={100} children={"12"} />
      <Droplet
        borderRadius="10px"
        lightSpot={8}
        lightSpotSize={{
...
export default class LightSpotSize extends React.Component {
  state: Readonly<{
    showCode: boolean;
  }> = {
    showCode: false,
