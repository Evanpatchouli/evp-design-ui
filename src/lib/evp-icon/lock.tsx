  ...
  return(
    <div className="evp icon" onClick={props.onClick} 
      ...
      <svg width={props.radius??24} height={props.radius??24} viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
        <rect x="6" y="22" width="36" height="22" rx="2" strokeLinejoin="round"/>
        <path d="M14 22V14C14 8.47715 18.4772 4 24 4C29.5228 4 34 8.47715 34 14V22" strokeLinecap="round" strokeLinejoin="round"/>
