...
const ZoomIn: SvgIcon = (props: SvgIconProps) => {
  return (
    <div
    ...
    >
      ...
      >
        ...
        />
        <path d="M21 15L21 27" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M15.0156 21.0156L27 21" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M33.2216 33.2217L41.7069 41.707" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  );
};
