...
const User: SvgIcon = (props: SvgIconProps)=>{
  return(
    <div className="evp icon" onClick={props.onClick} 
      ...
      >
        <circle cx="24" cy="12" r="8" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M42 44C42 34.0589 33.9411 26 24 26C14.0589 26 6 34.0589 6 44" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    </div>
  )
}
